			...
			<body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
				<ThemeProvider>
					<div className="min-h-screen flex flex-col">
						...
						<footer className="bg-muted/30 py-4 px-2 md:px-12">
							<div className="container mx-auto">
								{/* Bottom Bar */}
								<div className="border-t mt-4 pt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-sm text-muted-foreground">
